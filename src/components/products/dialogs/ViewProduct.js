...
export const ProductDialogView = ({ toggleViewDialog, toggleStockDialog, currentProduct, fetchProducts, setCurrentProduct }) => {

    return (
        <dialog id="dialog--product_view" className="dialog--product_view">
            {currentProduct ?
                <div>
                    <ProductDialogAddStock toggleStockDialog={toggleStockDialog} currentProduct={currentProduct} fetchProducts={fetchProducts} setCurrentProduct={setCurrentProduct} />
                    <div>
                        <button
