            ...
            <div>
                ...
                <div>
                    ...
                    <div className="=dropdown">
                        <select name="group_id" onChange={updateProduct} value={editMode ? updatedProduct.group_id : newProduct.groupId}>
                            <option value={newProduct.groupId}>Select a Group...</option>
                            {groups.map(group => {
